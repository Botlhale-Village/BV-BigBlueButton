      ...
      >
        ...
        { videoIsReady
          ...
          <div className={styles.info}>
            ...
            {voiceUser.muted && !voiceUser.listenOnly ? <Icon className={styles.muted} iconName="microphone" /> : null}
            {voiceUser.listenOnly ? <Icon className={styles.voice} iconName=" icon-bbb-listen" /> : null}
          </div>
          )
        }
      </div>
